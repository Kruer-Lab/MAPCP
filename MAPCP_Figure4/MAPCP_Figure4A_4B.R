...
## Figure 4A ##
rohData <- read_excel("/path/to/directory/SupplementaryTables_Revised.xlsx", sheet = "Supplementary Table 19", skip=1, col_names = TRUE) #change /path/to/directory to where the supplementary tables are
...
## Figure 4B ##
ConsangunityDf = read_excel("/path/to/directory/SupplementaryTables_Revised.xlsx", sheet = "Supplementary Table 20", skip=1, col_names = TRUE) #change /path/to/directory to where the supplementary tables are
