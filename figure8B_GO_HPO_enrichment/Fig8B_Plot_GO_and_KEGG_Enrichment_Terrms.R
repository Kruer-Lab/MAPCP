...
GOTermsDf <- read_excel("/path/to/directory/SupplementaryTables_11.05.25.xlsx", sheet = "Supplementary Table 16", skip=1, col_names = TRUE) # Change /path/to/directory to where the supplemental file is
...
KEGGTermsDf <- read_excel("/path/to/directory/SupplementaryTables_11.05.25.xlsx", sheet = "Supplementary Table 17", skip=1, col_names = TRUE)  # Change /path/to/directory to where the supplemental file is
